...
def main() -> None:
   ...
   # mini_visualizer.holding_time_for_exact_state([0, 1, 1], bins=20, rate=4.2, log_scale=False)
    ...
    events_trajectory = Multi_Trajectory("two_proteins_small.csv")
    events_visualizer = Visualize_Multi_Trajectory(events_trajectory)
    events_visualizer.holding_time_for_exact_state([1,0,0,1,0,0], bins=20, rate=1.2, log_scale=False, filename="two_proteins_small_holding_time.png")
